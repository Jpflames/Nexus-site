...
Set the Firebase environment variables before testing authentication, checkout, or admin uploads:
...
Firestore is used for payments, course records, and access grants. The app creates documents on demand, so there is no SQL schema to run.
